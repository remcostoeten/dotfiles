 ...
 */
export function printContainerStats(container: TContainer, stats: TContainerStats): void {
 ...
 */
export function printContainerList(containers: TContainer[], selectedIndex: number, multiSelect: Set<number>): void {
