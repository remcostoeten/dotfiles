              ...
              <button
                ...
                className={clsx(
                  ...
                  selectedCategory === category 
                    ? 'bg-blue-100 text-blue-800 border-blue-200 dark:bg-haptic.muted dark:text-haptic.text dark:border-haptic.border' 
                    : 'bg-gray-100 text-gray-600 border-gray-200 hover:bg-gray-200 dark:bg-haptic.muted dark:text-haptic.text dark:border-haptic.border dark:hover:bg-haptic.surface'
                )}
              >
                {category}
              </button>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <code className="text-xs bg-white dark:bg-haptic.surface dark:text-haptic.text px-2 py-1 rounded border border-gray-200 dark:border-haptic.border">
                      ${module.name}
                    </code>
                  </div>
                </div>
