  ...
  return (
    <div className="app h-screen bg-gray-50 dark:bg-haptic.bg flex flex-col">
      ...
      <header className="bg-white dark:bg-haptic.surface border-b border-gray-200 dark:border-haptic.border px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <button onClick={toggleSidebar} className="p-2 hover:bg-gray-100 dark:hover:bg-haptic.muted rounded-lg"><Menu size={20} /></button>
            <div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select value={promptState.palette.name} onChange={function onChange(e){ setPalette(defaultPalettes[e.target.value]); }} className="border border-gray-300 dark:border-haptic.border rounded px-3 py-1 text-sm bg-white dark:bg-haptic.muted text-gray-900 dark:text-haptic.text">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select value={activeScenario} onChange={function onChange(e){ setActiveScenario(e.target.value); }} className="border border-gray-300 dark:border-haptic.border rounded px-3 py-1 text-sm bg-white dark:bg-haptic.muted text-gray-900 dark:text-haptic.text">
      ...
      <div className="flex-1 flex overflow-hidden text-gray-900 dark:text-haptic.text">
        ...
        {activeFeature === 'starship' && (
          <>
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-gray-50 dark:bg-haptic.bg">
              ...
              <div className="w-1/2 border-l border-gray-200 dark:border-haptic.border">
                <TerminalPreview />
              </div>
            </div>
          </>
        ...
        {activeFeature !== 'starship' && (
          <div className="flex-1 grid place-items-center text-gray-600 dark:text-haptic.subtext">
      ...
      {showExportModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-haptic.surface dark:text-haptic.text rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto border border-gray-200 dark:border-haptic.border">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-haptic.text mb-2">TOML Configuration</label>
                <textarea readOnly value={exportToToml()} className="w-full h-64 p-3 border border-gray-300 dark:border-haptic.border rounded-lg font-mono text-sm bg-gray-50 dark:bg-haptic.bg dark:text-haptic.text" />
              </div>
              <div className="flex space-x-3">
                ...
                <button onClick={handleCopyToClipboard} className="flex-1 px-4 py-2 border border-gray-300 dark:border-haptic.border rounded-lg hover:bg-gray-50 dark:hover:bg-haptic.muted transition-colors flex items-center justify-center space-x-2 dark:text-haptic.text"><Save size={16} /><span>Copy to Clipboard</span></button>
              </div>
            </div>
          </div>
        </div>
      ...
      {applyOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-haptic.surface dark:text-haptic.text rounded-lg p-6 max-w-xl w-full mx-4 border border-gray-200 dark:border-haptic.border">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={applyPath} onChange={function onChange(e){ setApplyPath(e.target.value); }} className="w-full p-2 border border-gray-300 dark:border-haptic.border rounded bg-white dark:bg-haptic.muted text-gray-900 dark:text-haptic.text" />
              ...
              <div className="flex space-x-3">
                ...
                <button onClick={function close(){ setApplyOpen(false); }} className="flex-1 px-4 py-2 border border-gray-300 dark:border-haptic.border rounded-lg hover:bg-gray-50 dark:hover:bg-haptic.muted dark:text-haptic.text">Cancel</button>
              </div>
