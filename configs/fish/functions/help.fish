...
function _show_scripts_help
    ...
    echo "                   • PostgreSQL Manager • Database Analyzer • Turso Generator • Docker"
    echo "                   Run: 'db' (interactive) or 'db postgres', 'db analyze', etc."
    ...
    printf "  %-15s %s\n" "📝 Python:" "ui (unified toolkit), db (NEW!), postgres, db_analyzer.py"
