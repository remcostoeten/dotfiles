...
-- Available themes
local themes = {
  modern_gradient = { name = 'Modern Gradient', colors = modern_gradient, icon = '🌈' },
...
local theme_order = { 'modern_gradient', 'cyberdream', 'catppuccin', 'pumpkin', 'pumpkin_spice' }
...
return {
  -- Default theme (using Modern Gradient)
  colors = modern_gradient,
