...
-- Font configuration (optimized for aesthetics)
config.font = wezterm.font_with_fallback {
  {
    family = 'JetBrains Mono Nerd Font',  -- Primary font
    weight = 'Medium',
    harfbuzz_features = { 'calt', 'liga', 'ss01', 'ss02' },  -- Enhanced ligatures
  },
  {
    family = 'Hack Nerd Font',  -- Better Nerd Font variant
    harfbuzz_features = { 'calt', 'liga' },
  },
  { family = 'Symbols Nerd Font Mono' },  -- Icon fallback
}
config.font_size = 16.0             -- Font size
config.line_height = 1.15           -- Slightly tighter line height for better density
config.cell_width = 0.95            -- Reduced letter spacing for better aesthetics
